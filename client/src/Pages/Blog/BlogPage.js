...
const BlogPage = () => {
  ...
  return (
    <div id="blog-homepage">
      <button className="form-button" onClick={LinkToPostsForm}>Join The Conversation</button> 
      {/* <a href="./post" id="goToPostAnchor">Join The Conversation</a> */}
      <div id="blog-post-container">
        {blog.slice(0).reverse().map((val,i)=> {
          return(
          <div className="blog-post-div">
            <div className="name-level-div">
              <p id="name-p">{val.first_name} {val.last_name} </p>&nbsp;
