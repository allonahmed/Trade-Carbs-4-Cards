...
class PostPage extends React.Component {
    ...
    render() {
        ...
        return(
            <SubmitPostForm email={this.state.email} />
        )
  }
}
    ...
    <div id="post-homepage">
        <form id="submit-post-form">
            ...
            <div className="form-field">
                <textarea id="post-textarea" placeholder="Share your thoughts! (Max of 300 characters)" maxLength="300" name="my-post" onChange={(e) => {setContent(e.target.value)}}></textarea>
            </div>
            <div className="form-field">
                <button className="form-button" onClick={submitPost}>Post It!</button>
            </div>
        </form>
    </div>
    )
